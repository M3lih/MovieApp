...
namespace MovieApp.Web.Models
{
    ...
    public class AdminCreateMovieModel
    {
        ...
        [StringLength(50, MinimumLength = 3, ErrorMessage = "film adı için 3-50 karakter girilmeli")]
        public string Title { get; set; }

        [Display(Name = "Film açıklama")]
        [Required(ErrorMessage = "film açıklama girmelisiniz.")]
        [StringLength(3000, MinimumLength = 10, ErrorMessage = "film açıklma için 10-3000 karakter girilmeli")]
